<%-- 
    ...
    Created on : 02/03/2017, 02:11:04 PM
    Author     : CAMILO SALAS
--%>

<%@page import="com.test.dto.ProveedorDTO"%>
<jsp:useBean id="listaprove" scope="request" type="java.util.List<ProveedorDTO>"/>
...
<html>
   ...
   <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
     ...
     <div class="container">
    <button><a href="agregar/AgregarProveedor.jsp">Agregar Proveedor</a></button>
           <br>
           <br>
           <table align="center">
               <tr><td id="header" colspan="9"><h1>LISTA DE PROVEEDORES</h1></td></tr>
                <tr>
                    <th>ORDEN</th>
                    <th>NOMBRE</th>
                    <th>APELLIDO</th>
           ...
           <%
            ...
            for(ProveedorDTO u: listaprove){
                ...
                <tr>
                    ...
                    <td><%= u.getCelular()%></td>
                    <td><%= u.getCorreo()%></td>
                    <td><button><a href="rutaproveedor?pro=encontrarprove&idproveedor=<%= u.getIdproveedor()%>"> Editar </a></button>
                    <button><a href="rutaproveedor?pro=borrarprove&idproveedor=<%= u.getIdproveedor()%>"> Eliminar </a></button></td>
                </tr>
