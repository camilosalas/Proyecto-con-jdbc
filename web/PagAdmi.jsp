<%-- 
    Document   : PagVentas
    Created on : 06/11/2016, 09:21:20 AM
    Author     : CAMILO SALAS
--%>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="close">Bodega| Brissy</a>
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li>
                        ...
                        <a href="rutaproducto?op=lisProducto"><i class="fa fa-fw fa-bar-chart-o" data-toggle="modal" data-target="#myModal"></i> Productos</a>
                        
                    </li>
                    
                    <li>
                      
                        <a href="redirection?op=vendedor"><i class="glyphicon glyphicon-user" data-toggle="modal"></i> Vendedores </a>
                        
                    </li>
                    
                     <li>
                        <a href="rutaproveedor?pro=listarprove"><i class="glyphicon glyphicon-list-alt"></i> Proveedores </a>
					</li>
                    
                     <li>
                        <a href="#"><i class="glyphicon glyphicon-tags"></i> Compras </a>
					</li>
                   
                    <li>
                        <a href="direccion?op=listarCliente"><i class="glyphicon glyphicon-user"></i> Clientes</a>
		    </li>
  ...
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
   ...
   <div class="redes">
   <a href=""><img src="img/gmail.png" alt="" class="foto"></a>
   <a href=""><img src="img/hotmail.png" alt="" class="foto"></a>
   <a href="http://www.mega.cl/home/"><img src="img/mega.png" alt="" class="foto"></a>
   <a href="https://www.youtube.com/"><img src="img/YouTube.png" alt="" class="foto"></a>
   </div>
